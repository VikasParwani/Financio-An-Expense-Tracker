...
//         e.preventDefault()
//
//         console.log("Form submitted with transaction type:", newTransaction.type)
//         console.log("Full transaction data:", newTransaction)
//
//         if (!user) return
//
//         try {
...
//             }
//
//             console.log("Adding transaction with type:", newTransaction.type)
//
...
//             }
//
//             console.log("Transaction data being sent to Firestore:", transactionData)
//
...
//                                     {/*          category: e.target.value === "expense" ? "general" : newTransaction.category*/}
//                                     {/*        })}*/}
//                                     {/*        className="h-4 w-4"*/}
//                                     {/*    />*/}
...
//                                     {/*          ...newTransaction,*/}
//                                     {/*          type: e.target.value as "income" | "expense",*/}
//                                     {/*          category: e.target.value === "income" ? "salary" : newTransaction.category*/}
//                                     {/*        })}*/}
//                                     {/*        className="h-4 w-4"*/}
//                                     {/*    />*/}
